...
class WeatherForecastSummary extends Component {
    constructor(props) {
        super(props);
        this.onRadioChange = this::this.onRadioChange;
    }
    ...
    render() {
        const { className, forecast, forecastFilter } = this.props;
